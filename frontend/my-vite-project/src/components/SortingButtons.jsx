...
const SortingButtons = (props) => {
  ...
  return (
    <div className="flex z-40 flex-col absolute left-0 top-full bg-gray-800 text-white rounded shadow-lg">
      <button onClick={() => handleSortClick('createdAt')} className="w-full hover:bg-gray-700 py-4 px-8 rounded text-gray-200">Newest</button>
      <button onClick={() => handleSortClick('-createdAt')} className="w-full hover:bg-gray-700 py-4 px-4 rounded text-gray-200">Oldest</button>
